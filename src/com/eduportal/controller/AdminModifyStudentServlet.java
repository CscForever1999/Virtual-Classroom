...
/**
 * Servlet implementation class AdminModifyStudentServlet
 */
@WebServlet("/AdminModifyStudentServlet")
public class AdminModifyStudentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminModifyStudentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ps=(PreparedStatement) con.prepareStatement("select * from approvedstudent");
			...
			out.println("<tr>");	
			out.println("<th>Sid</th><th>Student Name</th>"
			...
			while(rs.next())
			{
				...
				out.println("<tr>");	
				out.println("<td>");
				out.println("<a href='displayServlet?roll="+rs.getString(1)+"'>");
