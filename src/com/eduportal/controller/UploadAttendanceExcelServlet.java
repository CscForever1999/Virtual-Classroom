...
import com.eduportal.service.GetAttendanceFromExcel;
import com.eduportal.service.GetFromExcel;

/**
 * Servlet implementation class UploadAttendanceExcelServlet
 */
@WebServlet("/UploadAttendanceExcelServlet")
public class UploadAttendanceExcelServlet extends HttpServlet {
     ...
     */
    public UploadAttendanceExcelServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while(fileItemsIterator.hasNext()){
				...
				fileloc = "E:\\UploadedFile\\Attendance\\"+fileItem.getName();
		...
		GetAttendanceFromExcel obj=new GetAttendanceFromExcel();
